...
class ConferencesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create conference" do
    assert_difference("Conference.count") do
      post conferences_url, params: { conference: { time: @conference.time, title: @conference.title } }
    end
  ...
  test "should update conference" do
    patch conference_url(@conference), params: { conference: { time: @conference.time, title: @conference.title } }
